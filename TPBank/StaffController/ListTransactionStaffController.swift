...
class ListTransactionStaffController: UIViewController{
    ...
    override func viewDidLoad() {
        ...
        refchild.observe(.childAdded, with: {(snapshot) in
            print(snapshot)
        var postDict = snapshot.childSnapshot(forPath: "\(AccountNumberSearch!)").value as?  [String:AnyObject]
            if postDict != nil {
                    ...
                    if ((postDict!["AccountDestination"]) as! String) != nil {
                        ...
                        if AccountDestination != AccountNumberSearch! {
...
extension ListTransactionStaffController : UITableViewDelegate,UITableViewDataSource,UISearchBarDelegate{
    ...
    @IBAction func btnBack(_ sender: UIBarButtonItem) {
        ...
        let initialViewController = self.storyboard!.instantiateViewController(withIdentifier: "SearchStaff")
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "CellTransactionStaff") as! CellTransactionStaffViewCell
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        if currentListTransactions[indexPath.row].Category == .Banking{
            ...
            if CodeBanking != nil {
                let appDelegate = UIApplication.shared.delegate! as! AppDelegate
                let initialViewController = self.storyboard!.instantiateViewController(withIdentifier: "BankingDetailStaff")
                appDelegate.window?.rootViewController = initialViewController
                appDelegate.window?.makeKeyAndVisible()
            }
        }else{
            ...
            if CodeCardPhone != nil {
                let appDelegate = UIApplication.shared.delegate! as! AppDelegate
                let initialViewController = self.storyboard!.instantiateViewController(withIdentifier: "CardPhoneDetailStaff")
                appDelegate.window?.rootViewController = initialViewController
                appDelegate.window?.makeKeyAndVisible()
            }
        }
